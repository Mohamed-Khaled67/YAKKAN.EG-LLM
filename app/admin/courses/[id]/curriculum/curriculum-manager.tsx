...
//   // Prevent double-click / duplicate save requests.
//   // A React state flag alone is not enough because two clicks
//   // can happen before the state update is reflected.
//   const saveLessonLock = useRef(false)
...
//     setVideoFile(null)
//     setVideoKey(lesson.videoKey ?? null)
...
//             reject(
//               new Error(
//                 `فشل رفع الفيديو إلى S3 (${xhr.status})`
//               )
//             )
//           }
//         }
...
//           reject(
//             new Error(
//               "حدث خطأ في الاتصال بـ S3 أثناء رفع الفيديو"
//             )
//           )
//         }
...
//     // IMPORTANT:
//     // Lock immediately before any async work starts.
//     // This prevents the same lesson from being uploaded twice
//     // if the Save button is clicked more than once quickly.
//     if (saveLessonLock.current) {
//       return
//     }

//     saveLessonLock.current = true
...
//           ) {
//             console.error(
//               "Failed to cleanup uploaded lesson video:",
//               cleanupError
//             )
//           }
//         }
...
//                 ابدأ بإضافة أول Chapter، وبعدها تقدر
//                 تضيف الدروس بداخله.
//               </p>
...
//                         يمكن للطلاب مشاهدة هذا الدرس
//                         بدون شراء أو تسجيل في الكورس
//                       </p>
//                     </div>
...
//                     <p className="mt-1 text-xs text-muted-foreground">
//                       ارفع فيديو الدرس وسيتم تخزينه على S3 بشكل آمن
//                     </p>
//                   </div>
...
//                               الفيديو جاهز للرفع عند الضغط على حفظ
//                             </p>
//                           </div>
//                         </div>
//                       </div>
...
//                           ) : (
//                             <Upload className="size-4 animate-pulse text-red-500" />
//                           )}
